...
from dse.connection import (ConnectionException, ConnectionShutdown,
                            ...
                            ContinuousPagingState, EndPoint, DefaultEndPoint,
                            DefaultEndPointFactory, SniEndPointFactory)
from dse import ProtocolVersion
from dse.cqltypes import UserType
from dse.encoder import Encoder
from dse.auth import _proxy_execute_key, PlainTextAuthProvider
...
from dse.protocol import (QueryMessage, ResultMessage,
                          ...
                          ProtocolHandler, TruncateError,
                          ServerError, IsBootstrappingErrorMessage)
...
from dse.insights.reporter import MonitorReporter
from dse.insights.util import version_supports_insights
...
from dse.util import _resolve_contact_points_to_string_map
from dse.compat import Mapping
from dse.datastax import cloud as dscloud
    ...
    * EXPERIMENTAL: :class:`dse.io.asyncioreactor.AsyncioConnection`
    ...
    def protocol_downgrade(self, host_endpoint, previous_version):
        ...
        log.warning("Downgrading core protocol version from %d to %d for %s. "
                    ...
                    "http://docs.datastax.com/en/developer/python-driver-dse/latest/api/dse/cluster.html#dse.cluster.Cluster.protocol_version", self.protocol_version, new_version, host_endpoint)
...
class Session(object):
    ...
    def execute(self, query, parameters=None, timeout=_NOT_SET, trace=False,
        ...
        `host` is the :class:`dse.pool.Host` that should handle the query. If the host specified is down or
