...
def register_connection(name, hosts=None, consistency=None, lazy_connect=False,
    ...
    :param int consistency: The default :class:`~.ConsistencyLevel` for the
        ...
        :attr:`.ExecutionProfile.consistency_level`. For use with ``hosts`` only;
...
def setup(
    ...
    :param int consistency: The global default :class:`~.ConsistencyLevel` - default is the same as :attr:`.ExecutionProfile.consistency_level`
